...
const filter = reactive({ company: '', dest: '', status: '' })
const rateForm = reactive({ id: 0, origin: '', destination: '', price_per_ton: null as number | null, effective_from: '', effective_to: '', note: '' })
const createForm = reactive({ origin: '', destination: '', price_per_ton: null as number | null, effective_from: today(), effective_to: '', note: '' })
...
function resetFilters() {
  Object.assign(filter, { company: '', dest: '', status: '' })
}
...
function openRate(row: any = null) {
  Object.assign(rateForm, row ? {
    ...
    note: row.note || '',
  } : { id: 0, origin: '', destination: '', price_per_ton: null, effective_from: '', effective_to: '', note: '' })
  rateOpen.value = true
}

function resetCreateForm() {
  Object.assign(createForm, { origin: '', destination: '', price_per_ton: null, effective_from: today(), effective_to: '', note: '' })
}
