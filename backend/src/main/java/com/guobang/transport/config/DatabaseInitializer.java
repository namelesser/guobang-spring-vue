...
public class DatabaseInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        List<String> statements = List.of(
                ...
                """,
                "ALTER TABLE images ADD COLUMN IF NOT EXISTS thumbnail_data BYTEA",
                "ALTER TABLE images ADD COLUMN IF NOT EXISTS thumbnail_mime_type TEXT DEFAULT 'image/jpeg'",
                "ALTER TABLE images ADD COLUMN IF NOT EXISTS thumbnail_updated_at TIMESTAMP",
                "ALTER TABLE images ADD COLUMN IF NOT EXISTS storage_backend TEXT DEFAULT 'db'",
